...
export default function Dashboard({ 
  ...
  const breakdown = useMemo(() => {
    const br: Record<string, number> = { transport: 0, energy: 0, food: 0, shopping: 0 };
    if (totalEmitted > 0) {
      Object.keys(categoriesSum).forEach(cat => {
        br[cat] = Math.round(((categoriesSum[cat] || 0) / totalEmitted) * 100);
      });
    }
    return br;
          ...
          <div className="category-list">
            ...
            <div className="category-item">
              <div className="category-meta">
                ...
                <span className="category-percentage">
                  {(categoriesSum.transport || 0).toFixed(1)} kg ({breakdown.transport || 0}%)
                </span>
              </div>
            ...
            <div className="category-item">
              <div className="category-meta">
                ...
                <span className="category-percentage">
                  {(categoriesSum.energy || 0).toFixed(1)} kg ({breakdown.energy || 0}%)
                </span>
              </div>
              <div className="progress-track">
                <div 
            ...
            <div className="category-item">
              <div className="category-meta">
                ...
                <span className="category-percentage">
                  {(categoriesSum.food || 0).toFixed(1)} kg ({breakdown.food || 0}%)
                </span>
              </div>
              <div className="progress-track">
                <div 
            ...
            <div className="category-item">
              <div className="category-meta">
                ...
                <span className="category-percentage">
                  {(categoriesSum.shopping || 0).toFixed(1)} kg ({breakdown.shopping || 0}%)
                </span>
              </div>
              <div className="progress-track">
                <div 
