...
export const EMISSION_FACTORS = {
  ...
  energy: {
    ...
    natural_gas: 0.20, // per kWh (or ~2.03 per m3)
 ...
 * @returns {number} emissions in kg CO2e
 */
export const calculateEnergy = (type, amount) => {
 ...
 * @param {number} days - Number of days (typically 1 or 7)
 * @returns {number} emissions in kg CO2e
 */
export const calculateFood = (dietType, days = 1) => {
 ...
 * @returns {number} emissions in kg CO2e
 */
export const calculateShopping = (category, quantity) => {
...
export const CHALLENGES = [
  {
    ...
    category: "food",
    co2Savings: 24.0, // savings vs average meat diet
    difficulty: "Medium",
    duration: "7 days"
  },
  {
    ...
    category: "transport",
    co2Savings: 5.1, // savings vs driving 30km petrol car
    difficulty: "Medium",
    duration: "Flexible"
  },
  {
  ...
  },
  {
    ...
    category: "transport",
    co2Savings: 150.0, // short roundtrip flight footprint
    difficulty: "Hard",
    duration: "One-time"
  },
  {
